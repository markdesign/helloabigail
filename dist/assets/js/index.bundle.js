...
var contexts = [/*#__PURE__*/(0,jsx_runtime.jsx)(AppProvider, {}, "appProvider")];
var ProviderComposer = function ProviderComposer(props) {
  return props.contexts.reduceRight(function (kids, parent) {
...
var ContextProvider = function ContextProvider(props) {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(ProviderComposer, {
    contexts: contexts,
    children: props.children
  });
};
...
/* harmony default export */ const src_components_App = (App);
...
root.render( /*#__PURE__*/(0,jsx_runtime.jsx)(src_components_App, {}));
})();
